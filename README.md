...
This is a package and a shell script for alternative polyadenylation (APA) analysis of single-cell RNA-seq data. The shell script "scAPAscript.R" takes as input BAM files generated by aligned using 10x 3' tag RNA seq pipline and the results of cell clustering.
